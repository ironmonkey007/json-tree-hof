...
module.exports = function() {
    ...
    // Flatten the tree to a list of nodes that each no longer have 
    // a "nodes" property listing their children
    function flatten(tree) {
        return mapToList(tree, function(x) { return _.omit(x, 'nodes')});
    }
